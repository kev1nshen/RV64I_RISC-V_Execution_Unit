-- ============================================================
-- TS_ExecUnit_16TS_ExecUnit_csel_SwapUp_c4.do
...
vcom -work work -2008 -explicit -stats=none ./ModelSim/c4csel16.vho
vcom -work work -2008 -explicit -stats=none ../SourceCode/ArithUnit.vhd

-- change this line depending on topology
vcom -work work -2008 -explicit -stats=none ./ModelSim/16swapupc4.vho
...
vsim -t 1ps -gui -sdfnoerror \
  -sdftyp /DUT/ArithInst/AdderInst=./ModelSim/c4csel16.sdo \
  -sdftyp /DUT/SubInst/AdderInst=./ModelSim/c4csel16.sdo \
  -sdftyp /DUT/ShiftInst=./ModelSim/16swapupc4.sdo \
