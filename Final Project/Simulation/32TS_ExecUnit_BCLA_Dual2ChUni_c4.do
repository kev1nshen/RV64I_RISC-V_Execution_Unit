-- ============================================================
-- TS_ExecUnit_32TS_ExecUnit_BCLA_DCB_c4.do
...
vcom -work work -2008 -explicit -stats=none ./ModelSim/c4BCLA32.vho
vcom -work work -2008 -explicit -stats=none ../SourceCode/ArithUnit.vhd

-- change this line depending on topology
vcom -work work -2008 -explicit -stats=none ./ModelSim/32DCB_c4.vho
...
vsim -t 1ps -gui -sdfnoerror \
  -sdftyp /DUT/ArithInst/AdderInst=./ModelSim/c4BCLA32.sdo \
  -sdftyp /DUT/SubInst/AdderInst=./ModelSim/c4BCLA32.sdo \
  -sdftyp /DUT/ShiftInst=./ModelSim/32DCB_c4.sdo \
