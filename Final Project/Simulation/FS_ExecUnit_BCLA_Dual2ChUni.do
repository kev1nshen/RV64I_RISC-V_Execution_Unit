-- ============================================================
-- FS_ExecUnit_BCLA_Dual2ChUni.do
-- Functional Simulation Script
-- Arithmetic : Block Carry Look Ahead
-- Shift      : Dual2ChUni
-- Target     : 
-- Transcript : FS_ExecUnit_BCLA_Dual2ChUni.txt
-- ============================================================

-- redirect transcript output to file
transcript file FS_ExecUnit_BCLA_Dual2ChUni.txt
transcript on
...
vcom -work work -2008 -explicit -stats=none ../SourceCode/Config_FS_BCLA_Dual2ChUni.vhd	
