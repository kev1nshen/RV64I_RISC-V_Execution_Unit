-- ============================================================
-- FS_ExecUnit_Cselect_SingleSW2Ch.do
-- Functional Simulation Script
-- Arithmetic : Carry Select
-- Shift      : SingleSW2Ch
-- Target     : 
-- Transcript : FS_ExecUnit_Cselect_SingleSW2Ch.txt
-- ============================================================
...
vcom -work work -2008 -explicit -stats=none ../SourceCode/Config_FS_Cselect_BSingleSW2Ch.vhd	
