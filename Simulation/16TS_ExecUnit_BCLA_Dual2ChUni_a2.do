-- ============================================================
-- TS_ExecUnit_16TS_ExecUnit_BCLA_DCB_a2.do
...
transcript file 16TS_ExecUnit_BCLA_DCB_a2.txt
transcript on
...
vcom -work work -2008 -explicit -stats=none ./ModelSim/a2BCLA16.vho
vcom -work work -2008 -explicit -stats=none ../SourceCode/ArithUnit.vhd

-- change this line depending on topology
vcom -work work -2008 -explicit -stats=none ./ModelSim/16a2DCB.vho
...
vsim -t 1ps -gui -sdfnoerror \
  -sdftyp /DUT/ArithInst/AdderInst=./ModelSim/a2BCLA16.sdo \
  -sdftyp /DUT/SubInst/AdderInst=./ModelSim/a2BCLA16.sdo \
  -sdftyp /DUT/ShiftInst=./ModelSim/16a2DCB.sdo \
