-- ============================================================
-- TS_ExecUnit_16TS_ExecUnit_csel_SwapUp_a2.do
...
vcom -work work -2008 -explicit -stats=none ./ModelSim/a2csel16.vho
vcom -work work -2008 -explicit -stats=none ../SourceCode/ArithUnit.vhd

-- change this line depending on topology
vcom -work work -2008 -explicit -stats=none ./ModelSim/16swapupa2.vho
...
vsim -t 1ps -gui -sdfnoerror \
  -sdftyp /DUT/ArithInst/AdderInst=./ModelSim/a2csel16.sdo \
  -sdftyp /DUT/SubInst/AdderInst=./ModelSim/a2csel16.sdo \
  -sdftyp /DUT/ShiftInst=./ModelSim/16swapupa2.sdo \
