-- ============================================================
-- TS_ExecUnit_16TS_ExecUnit_cskip_rev2ch64_a2.do
-- Functional Simulation Script
-- Arithmetic : CarrySkip adder
-- Shift      : rev2ch64
-- Target     : Arria 2
-- Transcript : 16TS_ExecUnit_cselect_SwapUp_a2.txt
-- ============================================================

-- redirect transcript output to file
transcript file 16TS_ExecUnit_cselect_SwapUp_a2.txt
transcript on
...
vcom -work work -2008 -explicit -stats=none ./ModelSim/a2cskip16.vho
vcom -work work -2008 -explicit -stats=none ../SourceCode/ArithUnit.vhd

-- change this line depending on topology
vcom -work work -2008 -explicit -stats=none ./ModelSim/16a2rev2ch64.vho
vcom -work work -2008 -explicit -stats=none ./ModelSim/16a2logicunit.vho
...
vsim -t 1ps -gui -sdfnoerror \
  -sdftyp /DUT/ArithInst/AdderInst=./ModelSim/a2cskip16.sdo \
  -sdftyp /DUT/SubInst/AdderInst=./ModelSim/a2cskip16.sdo \
  -sdftyp /DUT/ShiftInst=./ModelSim/16a2rev2ch64.sdo \
  -sdftyp /DUT/LogicInst=./ModelSim/16a2logicunit.sdo \
  work.ConfigTiming
