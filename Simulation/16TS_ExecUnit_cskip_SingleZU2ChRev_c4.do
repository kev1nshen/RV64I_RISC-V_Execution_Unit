-- ============================================================
-- TS_ExecUnit_16TS_ExecUnit_cskip_rev2ch64_c4.do
...
transcript file 16TS_ExecUnit_cselect_SwapUp_c4.txt
transcript on
...
vcom -work work -2008 -explicit -stats=none ./ModelSim/c4cskip16.vho
vcom -work work -2008 -explicit -stats=none ../SourceCode/ArithUnit.vhd

-- change this line depending on topology
vcom -work work -2008 -explicit -stats=none ./ModelSim/16c4rev2ch64.vho
...
vsim -t 1ps -gui -sdfnoerror \
  -sdftyp /DUT/ArithInst/AdderInst=./ModelSim/c4cskip16.sdo \
  -sdftyp /DUT/SubInst/AdderInst=./ModelSim/c4cskip16.sdo \
  -sdftyp /DUT/ShiftInst=./ModelSim/16c4rev2ch64.sdo \
