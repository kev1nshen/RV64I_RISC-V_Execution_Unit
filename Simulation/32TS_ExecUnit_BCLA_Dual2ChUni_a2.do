-- ============================================================
-- TS_ExecUnit_32TS_ExecUnit_BCLA_DCB_a2.do
...
vcom -work work -2008 -explicit -stats=none ./ModelSim/a2BCLA32.vho
vcom -work work -2008 -explicit -stats=none ../SourceCode/ArithUnit.vhd

-- change this line depending on topology
vcom -work work -2008 -explicit -stats=none ./ModelSim/32DCB_A2.vho
...
vsim -t 1ps -gui -sdfnoerror \
  -sdftyp /DUT/ArithInst/AdderInst=./ModelSim/a2BCLA32.sdo \
  -sdftyp /DUT/SubInst/AdderInst=./ModelSim/a2BCLA32.sdo \
  -sdftyp /DUT/ShiftInst=./ModelSim/32DCB_A2.sdo \
