-- ============================================================
-- TS_ExecUnit_32TS_ExecUnit_CSelect_SwapUp_C4.do
-- Functional Simulation Script
-- Arithmetic : CarrySelect adder
-- Shift      : SwapUp2Ch
-- Target     : Cyclone
-- Transcript : 32TS_ExecUnit_CSelect_SwapUp_C4.txt
-- ============================================================

-- redirect transcript output to file
transcript file 32TS_ExecUnit_CSelect_SwapUp_C4.txt
transcript on
...
vcom -work work -2008 -explicit -stats=none ./ModelSim/c4Csel32.vho
vcom -work work -2008 -explicit -stats=none ../SourceCode/ArithUnit.vhd

-- change this line depending on topology
vcom -work work -2008 -explicit -stats=none ./ModelSim/32swapupC4.vho
...
vsim -t 1ps -gui -sdfnoerror \
  -sdftyp /DUT/ArithInst/AdderInst=./ModelSim/c4Csel32.sdo \
  -sdftyp /DUT/SubInst/AdderInst=./ModelSim/c4Csel32.sdo \
  -sdftyp /DUT/ShiftInst=./ModelSim/32swapupC4.sdo \
