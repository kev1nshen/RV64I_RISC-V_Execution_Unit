-- ============================================================
-- TS_ExecUnit_32TS_ExecUnit_csum_SwapUp_a2.do
-- Functional Simulation Script
-- Arithmetic : CarrySelect adder
-- Shift      : SwapUp2Ch
-- Target     : Arria
-- Transcript : 32TS_ExecUnit_csumect_SwapUp_a2.txt
-- ============================================================

-- redirect transcript output to file
transcript file 32TS_ExecUnit_csumect_SwapUp_a2.txt
transcript on
...
vcom -work work -2008 -explicit -stats=none ./ModelSim/a2csum32.vho
...
vsim -t 1ps -gui -sdfnoerror \
  -sdftyp /DUT/ArithInst/AdderInst=./ModelSim/a2csum32.sdo \
  -sdftyp /DUT/SubInst/AdderInst=./ModelSim/a2csum32.sdo \
