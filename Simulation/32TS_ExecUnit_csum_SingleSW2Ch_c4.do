-- ============================================================
-- TS_ExecUnit_32TS_ExecUnit_csum_SwapUp_c4.do
-- Functional Simulation Script
-- Arithmetic : CarrySelect adder
-- Shift      : SwapUp2Ch
-- Target     : Cyclone
-- Transcript : 32TS_ExecUnit_csumect_SwapUp_c4.txt
-- ============================================================

-- redirect transcript output to file
transcript file 32TS_ExecUnit_csumect_SwapUp_c4.txt
transcript on
...
vcom -work work -2008 -explicit -stats=none ./ModelSim/c4csum32.vho
...
vsim -t 1ps -gui -sdfnoerror \
  -sdftyp /DUT/ArithInst/AdderInst=./ModelSim/c4csum32.sdo \
  -sdftyp /DUT/SubInst/AdderInst=./ModelSim/c4csum32.sdo \
