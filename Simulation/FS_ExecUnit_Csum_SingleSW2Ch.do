-- ============================================================
-- FS_ExecUnit_Csum_SingleSW2Ch.do
-- Functional Simulation Script
-- Arithmetic : Conditional Sum Adder
-- Shift      : SingleSW2Ch
-- Target     : 
-- Transcript : FS_ExecUnit_Csum_SingleSW2Ch.txt
-- ============================================================

-- redirect transcript output to file
transcript file FS_ExecUnit_Cselect_SingleSW2Ch.txt
transcript on
...
vcom -work work -2008 -explicit -stats=none ../SourceCode/Config_FS_Csum_BSingleSW2Ch.vhd	
