-- ============================================================
-- TS_ExecUnit_TS_ExecUnit_BCLA_DCB_a2.do
-- Functional Simulation Script
-- Arithmetic : BCLA adder
-- Shift      : DualChainbarrel
-- Target     : Arria
-- Transcript : TS_ExecUnit_CSkip_Rev2_a2.txt
-- ============================================================

-- redirect transcript output to file
transcript file TS_ExecUnit_BCLA_DCB_a2.txt
transcript on
...
vcom -work work -2008 -explicit -stats=none ./ModelSim/a2BCLA.vho
vcom -work work -2008 -explicit -stats=none ../SourceCode/ArithUnit.vhd

-- change this line depending on topology
vcom -work work -2008 -explicit -stats=none ./ModelSim/dualchainbarrel_A2.vho
...
vsim -t 1ps -gui -sdfnoerror \
  -sdftyp /DUT/ArithInst/AdderInst=./ModelSim/a2BCLA.sdo \
  -sdftyp /DUT/SubInst/AdderInst=./ModelSim/a2BCLA.sdo \
  -sdftyp /DUT/ShiftInst=./ModelSim/dualchainbarrel_A2.sdo \
