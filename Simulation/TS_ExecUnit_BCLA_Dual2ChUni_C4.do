-- ============================================================
-- TS_ExecUnit_TS_ExecUnit_BCLA_DCB_C4.do
-- Functional Simulation Script
-- Arithmetic : BCLA adder
-- Shift      : DualChainbarrel
-- Target     : Cyclone
-- Transcript : TS_ExecUnit_CSkip_Rev2_C4.txt
-- ============================================================

-- redirect transcript output to file
transcript file TS_ExecUnit_BCLA_DCB_C4.txt
transcript on
...
vcom -work work -2008 -explicit -stats=none ./ModelSim/c4BCLA.vho
...
vsim -t 1ps -gui -sdfnoerror \
  -sdftyp /DUT/ArithInst/AdderInst=./ModelSim/c4BCLA.sdo \
  -sdftyp /DUT/SubInst/AdderInst=./ModelSim/c4BCLA.sdo \
  -sdftyp /DUT/ShiftInst=./ModelSim/DualChainBarrel2x6_C4.sdo \
