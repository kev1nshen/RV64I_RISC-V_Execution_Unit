-- ============================================================
-- TS_ExecUnit_TS_ExecUnit_CSelect_SwapUp_C4.do
-- Functional Simulation Script
-- Arithmetic : CarrySelect adder
-- Shift      : SwapUp2Ch
-- Target     : Cyclone IV
-- Transcript : TS_ExecUnit_CSelect_SwapUp_C4.txt
-- ============================================================

-- redirect transcript output to file
transcript file TS_ExecUnit_CSelect_SwapUp_C4.txt
transcript on
...
vcom -work work -2008 -explicit -stats=none ./ModelSim/c4carryselect.vho
...
vsim -t 1ps -gui -sdfnoerror \
  -sdftyp /DUT/ArithInst/AdderInst=./ModelSim/c4carryselect.sdo \
  -sdftyp /DUT/SubInst/AdderInst=./ModelSim/c4carryselect.sdo \
