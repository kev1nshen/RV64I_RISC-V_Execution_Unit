-- ============================================================
-- TS_ExecUnit_TS_ExecUnit_CSkip_Rev2_A2.do
...
transcript file TS_ExecUnit_CSkip_Rev2_A2.txt
transcript on
...
vcom -work work -2008 -explicit -stats=none ./ModelSim/a2carryskip.vho
vcom -work work -2008 -explicit -stats=none ../SourceCode/ArithUnit.vhd

-- change this line depending on topology
vcom -work work -2008 -explicit -stats=none ./ModelSim/Rev2Ch64_A2.vho
...
vsim -t 1ps -gui -sdfnoerror \
  -sdftyp /DUT/ArithInst/AdderInst=./ModelSim/a2carryskip.sdo \
  -sdftyp /DUT/SubInst/AdderInst=./ModelSim/a2carryskip.sdo \
  -sdftyp /DUT/ShiftInst=./ModelSim/Rev2Ch64_A2.sdo \
