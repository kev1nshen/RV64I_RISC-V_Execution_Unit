-- ============================================================
-- TS_ExecUnit_TS_ExecUnit_CSkip_Rev2_C4.do
-- Functional Simulation Script
-- Arithmetic : CarrySkip adder
-- Shift      : Rev2Ch64
-- Target     : Cyclone
-- Transcript : TS_ExecUnit_CSkip_Rev2_C4.txt
-- ============================================================

-- redirect transcript output to file
transcript file TS_ExecUnit_CSkip_Rev2_C4.txt
transcript on
...
vcom -work work -2008 -explicit -stats=none ./ModelSim/C4carryskip.vho
vcom -work work -2008 -explicit -stats=none ../SourceCode/ArithUnit.vhd

-- change this line depending on topology
vcom -work work -2008 -explicit -stats=none ./ModelSim/Rev2Ch64_C4.vho
...
vsim -t 1ps -gui -sdfnoerror \
  -sdftyp /DUT/ArithInst/AdderInst=./ModelSim/C4carryskip.sdo \
  -sdftyp /DUT/SubInst/AdderInst=./ModelSim/C4carryskip.sdo \
  -sdftyp /DUT/ShiftInst=./ModelSim/Rev2Ch64_C4.sdo \
