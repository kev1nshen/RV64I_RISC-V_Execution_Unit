-- ============================================================
-- TS_ExecUnit_TS_ExecUnit_Csum_SingleSWSep2Ch_C4.do
-- Timing Simulation Script
-- Arithmetic : ConditionalSum
-- Shift      : SingleSWSep2Ch
-- Target     : Arria
-- Transcript : TS_ExecUnit_Csum_SingleSWSep2Ch_C4.txt
-- ============================================================

-- redirect transcript output to file
transcript file TS_ExecUnit_Csum_SwapUp_C4.txt
transcript on
...
vcom -work work -2008 -explicit -stats=none ./ModelSim/C4conditionalsum.vho
vcom -work work -2008 -explicit -stats=none ../SourceCode/ArithUnit.vhd

-- change this line depending on topology
vcom -work work -2008 -explicit -stats=none ./ModelSim/SwapUP_C4.vho
vcom -work work -2008 -explicit -stats=none ./ModelSim/C4logicunit.vho
...
vsim -t 1ps -gui -sdfnoerror \
  -sdftyp /DUT/ArithInst/AdderInst=./ModelSim/C4conditionalsum.sdo \
  -sdftyp /DUT/SubInst/AdderInst=./ModelSim/C4conditionalsum.sdo \
  -sdftyp /DUT/ShiftInst=./ModelSim/SwapUP_C4.sdo \
  -sdftyp /DUT/LogicInst=./ModelSim/C4logicunit.sdo \
  work.ConfigTiming
